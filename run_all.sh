...
rosbag_name_file="/home/larry/codeGit/run_slam_batch/vibration_test/name_new.txt"        # ChangeIt!

algorithm_prefix="fastlio"                                                              # ChangeIt! 
rosbag_folder="/home/larry/codeGit/run_slam_batch/vibration_test/"                           # ChangeIt!
trajectory_output_folder="/home/larry/codeGit/run_slam_batch/vibration_test/output/"                   # ChangeIt!
...
for bag in "${bags[@]}"; do
    ...
    tmux send-keys -t mysession "rosbag play ${full_rosbag_filename} -r 15; tmux wait-for -S signal_bagfinish" C-m      # ChangeIt!
